...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), sn = (e) => e.startsWith("onUpdate:"), Se = Object.assign, Xn = (e, t) => {
  const s = e.indexOf(t);
  s > -1 && e.splice(s, 1);
}, Uo = Object.prototype.hasOwnProperty, le = (e, t) => Uo.call(e, t), J = Array.isArray, Kt = (e) => Ts(e) === "[object Map]", gr = (e) => Ts(e) === "[object Set]", vi = (e) => Ts(e) === "[object Date]", ee = (e) => typeof e == "function", pe = (e) => typeof e == "string", We = (e) => typeof e == "symbol", ae = (e) => e !== null && typeof e == "object", mr = (e) => (ae(e) || ee(e)) && ee(e.then) && ee(e.catch), vr = Object.prototype.toString, Ts = (e) => vr.call(e), Ho = (e) => Ts(e).slice(8, -1), yr = (e) => Ts(e) === "[object Object]", nn = (e) => pe(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, ls = /* @__PURE__ */ Yn(
...
const wr = (e) => !!(e && e.__v_isRef === !0), te = (e) => pe(e) ? e : e == null ? "" : J(e) || ae(e) && (e.toString === vr || !ee(e.toString)) ? wr(e) ? te(e.value) : JSON.stringify(e, Sr, 2) : String(e), Sr = (e, t) => wr(t) ? Sr(e, t.value) : Kt(t) ? {
...
function Tl(e, t, s = fe) {
  ...
  }, t ? n ? H(!0) : y = c.run() : o ? o(H.bind(null, !0), !0) : c.run(), k.pause = c.pause.bind(c), k.resume = c.resume.bind(c), k.stop = k, k;
}
...
function Al(e) {
  let t = et + 1, s = Me.length;
  for (; t < s; ) {
    const n = t + s >>> 1, i = Me[n], r = xs(i);
...
function li(e) {
  if (!(e.flags & 1)) {
    const t = xs(e), s = Me[Me.length - 1];
    !s || // fast path when the job id is larger than the tail
    !(e.flags & 2) && t >= xs(s) ? Me.push(e) : Me.splice(Al(t), 0, e), e.flags |= 1, Br();
  }
}
function Br() {
  Ks || (Ks = jr.then(Kr));
...
function Kr(e) {
  try {
    ...
    et = -1, Me.length = 0, Wr(), Ks = null, (Me.length || zt.length) && Kr();
  }
}
let Be = null, zr = null;
function zs(e) {
...
function $l(e, t, s) {
  const n = this.proxy, i = pe(e) ? e.includes(".") ? Gr(n, e) : () => n[e] : e.bind(n, n);
  let r;
  ee(t) ? r = t : (r = t.handler, s = t);
  const o = As(this), l = Jr(i, r.bind(n), s);
  return o(), l;
}
function Gr(e, t) {
  const s = t.split(".");
...
const bt = /* @__PURE__ */ new WeakMap(), Yr = /* @__PURE__ */ Symbol("_vte"), Xr = (e) => e.__isTeleport, Pt = (e) => e && (e.disabled || e.disabled === ""), Ol = (e) => e && (e.defer || e.defer === ""), wi = (e) => typeof SVGElement < "u" && e instanceof SVGElement, Si = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, Un = (e, t) => {
  ...
  process(e, t, s, n, i, r, o, l, a, f) {
    const {
      ...
      pc: h,
      pbc: m,
      o: { insert: v, querySelector: C, createText: I, createComment: D, parentNode: k }
    } = f, y = Pt(t.props);
    ...
    if (e == null) {
      ...
      const _ = t.target = e.target, j = t.targetAnchor = e.targetAnchor, Y = Pt(e.props), E = Y ? s : _, K = Y ? P : j;
...
const He = [Function, Array], Zr = {
  ...
  setup(e, { slots: t }) {
    ...
    return () => {
      ...
      if (c && c.type !== Re && !Lt(c, a) && Qr(s).type !== Re) {
        let h = Vn(
          c,
          o,
          n,
...
function Vn(e, t, s, n, i) {
  const {
    ...
    enter(_) {
      ...
      let K = !1;
      _[ts] = (_e) => {
        K || (K = !0, _e ? Q(E, [_]) : Q(Y, [_]), N.delayedLeave && N.delayedLeave(), _[ts] = void 0);
      };
...
function so(e, t = !1, s) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    o.type === ie ? (o.patchFlag & 128 && i++, n = n.concat(
      so(o.children, t, l)
    )) : (t || o.type !== Re) && n.push(l != null ? St(o, { key: l }) : o);
  }
  if (i > 1)
...
function dn(e, t, s = Pe, n = !1) {
  if (s) {
    const i = s[e] || (s[e] = []), r = t.__weh || (t.__weh = (...o) => {
      rt();
      const l = As(s), a = Ke(t, s, e, o);
      return l(), ot(), a;
    });
...
function ea(e) {
  ...
  Bn = !1, t.beforeCreate && Ai(t.beforeCreate, e, "bc");
  const {
    // state
    data: i,
    computed: r,
  ...
  if (i) {
    const W = i.call(s, s);
    ae(W) && (e.data = /* @__PURE__ */ an(W));
  }
  if (Bn = !0, r)
    for (const W in r) {
      const se = r[W], ve = ee(se) ? se.bind(s, s) : ee(se.get) ? se.get.bind(s, s) : it, xe = !ee(se) && ee(se.set) ? se.set.bind(s) : it, ze = $e({
        get: ve,
        set: xe
      });
  ...
  c && Ai(c, e, "c");
  function B(W, se) {
    J(se) ? se.forEach((ve) => W(ve.bind(s))) : se && W(se.bind(s));
  }
  if (B(Kl, h), B(hn, m), B(zl, v), B(ql, C), B(jl, I), B(Bl, D), B(Xl, N), B(Yl, Q), B(Gl, P), B(ai, y), B(ro, R), B(Jl, _), J(j))
    if (j.length) {
  ...
  z && e.render === it && (e.render = z), Y != null && (e.inheritAttrs = Y), E && (e.components = E), K && (e.directives = K), _ && no(e);
}
...
function aa(e, t, ...s) {
  ...
  o && (o.trim && (i = s.map((c) => pe(c) ? c.trim() : c)), o.number && (i = s.map(Zn)));
...
function Ri(e) {
  ...
  return s.dirs && (H = St(H, null, !1, !0), H.dirs = H.dirs ? H.dirs.concat(s.dirs) : s.dirs), s.transition && ws(H, s.transition), k = H, zs(D), k;
}
const ua = (e) => {
  let t;
  for (const s in e)
...
function xa(e, t) {
  ...
  const {
    ...
    const re = wa(S, q);
    re && q.beforeEnter(M), n(M, d, g), ((x = G && G.onVnodeMounted) || re || X) && Ae(() => {
      try {
    ...
    let X;
    if (g && At(g, !1), (X = q.onVnodeBeforeUpdate) && Qe(X, g, d, u), G && Et(d, u, g, "beforeUpdate"), g && At(g, !0), // #6385 the old vnode may be a user-wrapped non-isomorphic block
    ...
    if (fn(u) && (L.ctx.renderer = Zt), La(L, !1, F), L.asyncDep) {
      if (S && S.registerDep(L, B, F), !u.el) {
        const M = L.subTree = ne(Re);
        k(null, M, d, g), u.placeholder = M.el;
      }
    } else
      B(
        L,
    ...
    const L = () => {
      if (u.isMounted) {
        let { next: U, bu: q, u: X, parent: re, vnode: ue } = u;
        {
          const Xe = bo(u);
          if (Xe) {
            U && (U.el = ue.el, W(u, U, F)), Xe.asyncDep.then(() => {
              Ae(() => {
                u.isUnmounted || x();
              }, S);
            });
        ...
        let ce = U, be;
        At(u, !1), U ? (U.el = ue.el, W(u, U, F)) : U = ue, q && Us(q), (be = U.props && U.props.onVnodeBeforeUpdate) && Qe(be, re, U, ue), At(u, !0);
        ...
        u.subTree = Ce, I(
          ...
          S,
          b
        ), U.el = Ce.el, ce === null && ha(u, Ce.el), X && Ae(X, S), (be = U.props && U.props.onVnodeUpdated) && Ae(
          () => Qe(be, re, U, ue),
          S
        );
      } else {
        ...
        At(u, !1), re && Us(re), !Ye && (U = X && X.onVnodeBeforeMount) && Qe(U, ce, d), At(u, !0);
        {
        ...
        if (ue && Ae(ue, S), !Ye && (U = X && X.onVnodeMounted)) {
          const Xe = d;
          Ae(
            () => Qe(U, ce, Xe),
            S
        ...
        (d.shapeFlag & 256 || ce && ds(ce.vnode) && ce.vnode.shapeFlag & 256) && u.a && Ae(u.a, S), u.isMounted = !0, d = g = T = null;
      }
    };
    u.scope.on();
    ...
    G.i = u, G.id = u.uid, M.scheduler = () => li(G), At(u, !0), x();
  }, W = (u, d, g) => {
    d.component = u;
    ...
    if (T !== 2 && x & 1 && L)
      if (T === 0)
        L.persisted && !b[Ve] ? n(b, d, g) : (L.beforeEnter(b), n(b, d, g), Ae(() => L.enter(b), S));
      else {
    ...
    if (ce && (be = F && F.onVnodeBeforeUnmount) && Qe(be, d, u), G & 6)
      ...
      (b !== ie || U > 0 && U & 64) ? Xt(
        ...
        !1,
        !0
      ) : (b === ie && U & 384 || !S && G & 16) && Xt(M, d, g), T && ks(u);
    }
    const Ce = re != null && X == null;
    (ce && (be = F && F.onVnodeUnmounted) || ue || Ce) && Ae(() => {
    ...
    $i(M), $i(x), T && Us(T), S.stop(), b && (b.flags |= 8, Le(F, u, d, g)), L && Ae(L, d), Ae(() => {
      u.isUnmounted = !0;
    }, d);
...
function fi(e, t, s = !1) {
  ...
  if (J(n) && J(i))
    for (let r = 0; r < n.length; r++) {
      const o = n[r];
      let l = i[r];
      l.shapeFlag & 1 && !l.dynamicChildren && ((l.patchFlag <= 0 || l.patchFlag === 32) && (l = i[r] = ft(i[r]), l.el = o.el), !s && l.patchFlag !== -2 && fi(o, l)), l.type === gn && (l.patchFlag === -1 && (l = i[r] = ft(l)), l.el = o.el), l.type === Re && !l.el && (l.el = o.el);
    }
}
function Sa(e) {
  const t = e.slice(), s = [0];
...
const ie = /* @__PURE__ */ Symbol.for("v-fgt"), gn = /* @__PURE__ */ Symbol.for("v-txt"), Re = /* @__PURE__ */ Symbol.for("v-cmt"), Hs = /* @__PURE__ */ Symbol.for("v-stc"), ps = [];
let Fe = null;
function A(e = !1) {
  ps.push(Fe = e ? null : []);
}
...
const Co = ({ key: e }) => e ?? null, Vs = ({
  ...
  ref_key: t,
  ref_for: s
}) => (typeof e == "number" && (e = "" + e), e != null ? pe(e) || /* @__PURE__ */ me(e) || ee(e) ? { i: Be, r: e, k: t, f: !!s } : e : null);
function p(e, t = null, s = null, n = 0, i = null, r = e === ie ? 0 : 1, o = !1, l = !1) {
  ...
  return l ? (Xs(a, s), r & 128 && e.normalize(a)) : s && (a.shapeFlag |= pe(s) ? 8 : 16), Ss > 0 && // avoid a block node from tracking itself
...
function Ta(e, t = null, s = null, n = 0, i = null, r = !1) {
  ...
  if (Na(e) && (e = e.__vccOpts), t) {
    ...
    l && !pe(l) && (t.class = ye(l)), ae(a) && (/* @__PURE__ */ cn(a) && !J(a) && (a = Se({}, a)), t.style = $t(a));
  }
  const o = pe(e) ? 1 : wo(e) ? 128 : Xr(e) ? 64 : ae(e) ? 4 : ee(e) ? 2 : 0;
  return p(
    e,
    t,
    s,
...
function Te(e = "", t = !1) {
  return t ? (A(), gt(Re, null, e)) : ne(Re, null, e);
}
function st(e) {
  return e == null || typeof e == "boolean" ? ne(Re) : J(e) ? ne(
    ie,
    null,
...
function $a(e, t) {
  ...
  if (n) {
    rt();
    const i = e.setupContext = n.length > 1 ? Da(e) : null, r = As(e), o = Es(
      n,
      e,
      0,
      [
...
}, yt = "transition", ss = "animation", Is = /* @__PURE__ */ Symbol("_vtc"), Ao = {
  name: String,
  type: String,
  css: {
    type: Boolean,
...
function za(e) {
  ...
  const {
    ...
    E._enterCancelled = _e, Mt(E, K ? c : l), Mt(E, K ? f : o), Z && Z();
  }, j = (E, K) => {
    E._isLeaving = !1, Mt(E, h), Mt(E, v), Mt(E, m), K && K();
  }, Y = (E) => (K, Z) => {
    const _e = E ? P : y, B = () => _(K, E, Z);
    kt(_e, [K, B]), Hi(() => {
      Mt(K, E ? a : r), at(K, E ? c : l), Ui(_e) || Vi(K, n, I, B);
    });
  };
  return Se(t, {
    onBeforeEnter(E) {
      kt(k, [E]), at(E, r), at(E, o);
    },
    onBeforeAppear(E) {
      kt(Q, [E]), at(E, a), at(E, f);
    },
    onEnter: Y(!1),
    onAppear: Y(!0),
    onLeave(E, K) {
    ...
    onEnterCancelled(E) {
      _(E, !1, void 0, !0), kt(H, [E]);
    },
    onAppearCancelled(E) {
      _(E, !0, void 0, !0), kt(N, [E]);
    },
    onLeaveCancelled(E) {
      j(E), kt(z, [E]);
    }
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, uc = (e, t, s, n, i, r) => {
  ...
  e._def.__asyncLoader && (/[A-Z]/.test(t) || !pe(n))) ? Gi(e, qe(t), n, r, t) : (t === "true-value" ? e._trueValue = n : t === "false-value" && (e._falseValue = n), Ji(e, t, n, o));
};
function fc(e, t, s, n) {
  if (n)
...
function Oo(e, t, s = {}, n, i, r) {
  ...
  const H = (N, _ = "") => {
    ...
    const j = function() {
      vn(n);
      const Y = Array.from(arguments), E = [], K = [];
      function Z(W) {
        E.push(W);
      }
      function _e(W) {
      ...
      let B;
      try {
        B = N.apply(this && this.$id === e ? this : z, Y);
      } catch (W) {
        throw Ut(K, W), W;
      }
      return B instanceof Promise ? B.then((W) => (Ut(E, W), W)).catch((W) => (Ut(K, W), Promise.reject(W))) : (Ut(E, B), B);
    };
...
const Yt = /* @__PURE__ */ yn("playlist", {
  ...
  setup(e) {
    return (t, s) => (A(), O("svg", {
      ...
      e.name === "play" ? (A(), O("polygon", Hc)) : e.name === "pause" ? (A(), O(ie, { key: 1 }, [
        s[0] || (s[0] = p("rect", {
          x: "6",
          y: "4",
          width: "4",
      ...
      ], 64)) : e.name === "repeat-one" ? (A(), O(ie, { key: 5 }, [
      ...
      ], 64)) : e.name === "shuffle" ? (A(), O(ie, { key: 6 }, [
      ...
      ], 64)) : e.name === "chevron-down" ? (A(), O("polyline", Vc)) : e.name === "chevron-up" ? (A(), O("polyline", jc)) : e.name === "music" ? (A(), O(ie, { key: 12 }, [
      ...
      ], 64)) : e.name === "volume" ? (A(), O(ie, { key: 13 }, [
        s[21] || (s[21] = p("polygon", {
      ...
      ], 64)) : e.name === "volume-mute" ? (A(), O(ie, { key: 14 }, [
        s[24] || (s[24] = p("polygon", {
          points: "11 5 6 9 2 9 2 15 6 15 11 19 11 5",
          fill: "currentColor",
          stroke: "none"
      ...
      ], 64)) : e.name === "check" ? (A(), O("polyline", Bc)) : e.name === "loader" ? (A(), O(ie, { key: 16 }, [
      ...
      ], 64)) : e.name === "list-music" ? (A(), O(ie, { key: 17 }, [
  ...
  for (const [n, i] of t)
    s[n] = i;
  return s;
}, ge = /* @__PURE__ */ Tt(Wc, [["__scopeId", "data-v-4bfc4099"]]), Kc = {
  key: 0,
  ...
  setup(e) {
    ...
    const I = /* @__PURE__ */ he(null), D = /* @__PURE__ */ he(null), k = /* @__PURE__ */ he(0), y = /* @__PURE__ */ he(0);
    function H() {
    ...
    Ne(a, () => {
      y.value = 0, k.value = 0, De(() => requestAnimationFrame(H));
    });
    function R() {
      i.value = !0;
    }
    ...
    }), (P, N) => n.isDock && !n.isMobile ? (A(), O("div", Kc, [
      r.value && !i.value ? (A(), O("div", zc, [
        p("img", {
          src: r.value,
          alt: "",
          onError: R
    ...
    ])) : n.isDock && n.isMobile ? (A(), O("div", Qc, [
      r.value && !i.value ? (A(), O("div", eu, [
        p("img", {
          src: r.value,
          alt: "",
          onError: R
  ...
  setup(e) {
    ...
    return (h, m) => (A(), O("div", mu, [
      ...
      w(t).isEmpty ? (A(), O("div", _u, te(w(V)("No Songs")), 1)) : (A(), O(ie, { key: 2 }, je(["chat", "user", "local"], (v) => p("div", {
        key: v,
        class: "stmp-group"
      }, [
        l.value[v].length ? (A(), O(ie, { key: 0 }, [
          p("div", bu, te(a[v]), 1),
          (A(!0), O(ie, null, je(l.value[v], (C) => (A(), O("div", {
            key: C.item.id,
            ...
            p("div", Su, [
              ...
              C.item.artist ? (A(), O("span", Iu, te(C.item.artist), 1)) : Te("", !0)
            ]),
            p("button", {
              class: "stmp-item-del",
...
}), Au = /* @__PURE__ */ Tt(Eu, [["__scopeId", "data-v-a0435f62"]]), ku = { class: "stmp-search" }, Mu = { class: "stmp-search-bar" }, Ru = ["placeholder"], Pu = ["disabled"], Lu = {
  key: 0,
  ...
  setup(e) {
    ...
    return (v, C) => (A(), O("div", ku, [
      ...
      w(t).isSearching ? (A(), O("div", Ou, te(w(V)("Searching...")), 1)) : i.value && !w(t).results.length ? (A(), O("div", Du, te(w(V)("No results")), 1)) : !i.value && !w(t).results.length ? (A(), O("div", Nu, te(w(V)("Type a song name to search")), 1)) : Te("", !0),
      w(t).results.length ? (A(), O("div", Fu, [
        (A(!0), O(ie, null, je(w(t).results, (I) => (A(), O("div", {
          key: I.provider + I.id,
          ...
          p("div", {
            ...
            I.artist ? (A(), O("span", Vu, te(I.artist), 1)) : Te("", !0)
          ], 8, Uu),
          p("button", {
  ...
  setup(e) {
    ...
    async function D() {
      await De();
      const E = t.currentLyricIndex, K = C.value;
      if (!K || E < 0) {
        m.value = 0;
        return;
      }
      const Z = v.value[E];
      if (!Z) return;
      const _e = Z.offsetTop, B = Z.offsetHeight, W = K.clientHeight;
      m.value = _e - W / 2 + B / 2;
    }
    ...
    function k(E) {
      const K = Math.floor(E / 60), Z = Math.floor(E % 60);
    ...
    function z() {
      const E = n.settings.playMode, K = H.indexOf(E), Z = H[(K + 1) % H.length];
      n.setPlayMode(Z);
    }
    function Q(E) {
      const K = E.target;
    ...
    return (E, K) => (A(), O("div", Ku, [
      ...
      p("div", {
        ...
        p("div", {
          ...
          p("div", Ju, [
            f.value && !o.value ? (A(), O("img", {
              key: 0,
              src: f.value,
              alt: "cover",
              onError: c
            }, null, 40, Gu)) : (A(), O("div", Yu, [
              ne(ge, {
                name: "music",
                size: 48
              })
        ...
        p("div", {
          ...
          p("div", {
            ...
            w(t).lyrics.length > 0 ? (A(), O("div", {
              ...
              (A(!0), O(ie, null, je(w(t).lyrics, (Z, _e) => (A(), O("div", {
                key: _e,
                ref_for: !0,
                ref: (B) => I(B, _e),
      ...
      p("div", sf, [
        ...
        p("div", rf, [
          p("span", null, te(k(w(t).currentTime)), 1),
          p("span", null, te(k(w(t).duration)), 1)
        ])
      ]),
      p("div", of, [
        p("div", lf, [
          p("button", {
            ...
            onClick: K[2] || (K[2] = Bt((Z) => j("search"), ["stop"]))
          }, [
            ne(ge, {
              name: "search",
              size: 18
        ...
        p("button", {
          ...
          "aria-label": w(t).isPlaying ? w(V)("Pause") : w(V)("Play"),
          onClick: K[4] || (K[4] = (Z) => w(t).togglePlay())
        }, [
          ne(ge, {
            name: w(t).isPlaying ? "pause" : "play",
            size: 24
        ...
        p("button", {
          ...
          onClick: K[6] || (K[6] = Bt((Z) => j("list"), ["stop"]))
        }, [
          ne(ge, {
            name: "list-music",
            size: 18
      ...
      ne(Ka, { name: "stmp-overlay" }, {
        default: qr(() => [
          r.value ? (A(), O("div", vf, [
            p("div", yf, [
              p("span", _f, te(r.value === "list" ? w(V)("Playlist") : w(V)("Search")), 1),
              p("button", {
            ...
            p("div", xf, [
              r.value === "list" ? (A(), gt(Au, { key: 0 })) : (A(), gt(Wu, { key: 1 }))
            ])
          ])) : Te("", !0)
        ]),
        _: 1
...
}), cr = /* @__PURE__ */ Tt(wf, [["__scopeId", "data-v-4bf7f7af"]]), Sf = {
  key: 1,
  class: "stmp-inline-expanded"
}, ur = 3, Cf = 500, If = /* @__PURE__ */ It({
  __name: "App",
  setup(e) {
    const t = ke(), s = Nt(), n = /* @__PURE__ */ he(!1), i = /* @__PURE__ */ he(null);
    let r = null;
    const o = $e(() => t.settings.widgetMode === "dock"), l = $e(() => t.settings.widgetMode === "inline"), a = $e(() => t.settings.widgetMode === "hidden"), f = /* @__PURE__ */ he(window.innerWidth <= 768), c = /* @__PURE__ */ he(!1), h = (B) => {
      B.key === "Escape" && (n.value = !1), B.key === " " && B.target === document.body && (B.preventDefault(), s.togglePlay());
    };
    let m = 0, v = 0, C = 0, I = 0, D = !1, k = !1, y = 0, H = !1, R = null, z = null;
    function Q(B) {
      if (o.value) return;
      const W = B.target;
      if (W.closest("input, .stmp-result, .stmp-item, .stmp-upload-btn, .stmp-search-input, .stmp-controls, .stmp-lyrics, .stmp-overlay, .stmp-display, .stmp-overlay-close") || n.value && (!W.closest(".stmp-drag-handle") || W.closest("button")) || !n.value && W.closest("button"))
        return;
      const se = i.value?.getBoundingClientRect();
      se && (m = B.clientX, v = B.clientY, C = se.left, I = se.top, D = !1, k = !0, y = Date.now(), H = !1, i.value && (i.value.style.left = se.left + "px", i.value.style.top = se.top + "px", i.value.style.right = "auto", i.value.style.bottom = "auto"), R = P, z = N, document.addEventListener("pointermove", R), document.addEventListener("pointerup", z), B.preventDefault());
    }
    function P(B) {
      if (!i.value || !k) return;
      const W = B.clientX - m, se = B.clientY - v;
      (Math.abs(W) > ur || Math.abs(se) > ur) && (D = !0);
      let ve = C + W, xe = I + se;
      const ze = i.value.offsetWidth || 60, Le = i.value.offsetHeight || 40, ks = window.innerWidth - ze, _n = window.innerHeight - Le;
      ve = Math.max(0, Math.min(ve, ks)), xe = Math.max(0, Math.min(xe, _n)), i.value.style.left = ve + "px", i.value.style.top = xe + "px";
    }
    function N() {
      k = !1, R && document.removeEventListener("pointermove", R), z && document.removeEventListener("pointerup", z), R = null, z = null;
      const B = Date.now() - y;
      if (D) {
        if (H = !0, i.value) {
          const W = i.value.getBoundingClientRect();
          t.setPosition({ x: W.left, y: W.top }), n.value && De(() => _());
        }
        return;
      }
      if (B > Cf) {
    ...
    function _() {
      if (!i.value) return;
      const B = i.value.getBoundingClientRect(), W = i.value.offsetWidth, se = i.value.offsetHeight;
      let ve = B.left, xe = B.top;
      ve + W > window.innerWidth && (ve = window.innerWidth - W), xe + se > window.innerHeight && (xe = window.innerHeight - se), ve < 0 && (ve = 0), xe < 0 && (xe = 0), i.value.style.left = ve + "px", i.value.style.top = xe + "px", i.value.style.right = "auto", i.value.style.bottom = "auto", t.setPosition({ x: ve, y: xe });
    }
    function j() {
      if (!i.value || !o.value) return;
      const B = document.querySelector("#send_form");
      if (!B) return;
      const W = B.getBoundingClientRect(), se = i.value.offsetHeight || 38, ve = Math.max(80, W.top - 8);
      i.value.style.maxHeight = ve + "px";
      let xe = W.top - Math.min(se, ve);
      if (xe < 4 && (xe = 4), window.innerWidth <= 768)
        i.value.style.left = W.left + "px", i.value.style.width = W.width + "px";
      else {
        const ze = t.settings.dockAlign === "right", Le = i.value.offsetWidth;
        ze ? i.value.style.left = W.right - Le + "px" : i.value.style.left = W.left + "px", i.value.style.width = "";
      }
    ...
    function Y() {
      ...
      B ? (i.value.style.left = B.x + "px", i.value.style.top = B.y + "px", i.value.style.right = "auto", i.value.style.bottom = "auto", window.innerWidth <= 768 && De(() => _())) : (i.value.style.right = "16px", i.value.style.top = "16px", i.value.style.left = "auto", i.value.style.bottom = "auto");
    }
    function E(B) {
      if (H) {
        H = !1;
    ...
    function K(B) {
      n.value || B.target.closest("button, input") || Z();
    }
    function Z() {
      n.value = !n.value, De(() => {
    ...
    Ne(() => t.settings.widgetMode, (B) => {
      n.value = !1, i.value && (i.value.style.width = "", i.value.style.left = "", i.value.style.top = "", i.value.style.right = "", i.value.style.bottom = "", i.value.style.maxHeight = ""), B === "inline" && (c.value = !!document.querySelector("#send_form")), De(() => {
        B === "dock" ? j() : B === "drag" && Y();
      });
...
}), Tf = /* @__PURE__ */ Tt(If, [["__scopeId", "data-v-18adfe29"]]), Ef = { class: "stmp-switch-row" }, Af = {
  key: 0,
  class: "stmp-switch-label"
}, kf = { class: "stmp-switch" }, Mf = ["checked"], Rf = /* @__PURE__ */ It({
  __name: "ToggleSwitch",
  props: {
  ...
  setup(e, { emit: t }) {
    ...
    return (i, r) => (A(), O("label", Ef, [
      e.label ? (A(), O("span", Af, te(e.label), 1)) : Te("", !0),
      p("span", kf, [
        p("input", {
          type: "checkbox",
...
}), fr = /* @__PURE__ */ Tt(Rf, [["__scopeId", "data-v-d86a29bd"]]), Pf = { class: "stmp-settings" }, Lf = { class: "stmp-tab-bar" }, $f = ["onClick"], Of = { class: "stmp-tab-content" }, Df = { class: "stmp-tab-panel" }, Nf = { class: "stmp-setting-group" }, Ff = { class: "stmp-setting-label" }, Uf = { class: "stmp-mode-toggle" }, Hf = ["onClick"], Vf = {
  key: 0,
  class: "stmp-setting-group"
}, jf = { class: "stmp-setting-label" }, Bf = { class: "stmp-mode-toggle" }, Wf = ["onClick"], Kf = { class: "stmp-setting-group" }, zf = { class: "stmp-setting-label" }, qf = ["value"], Jf = { class: "stmp-setting-group" }, Gf = {
  class: "stmp-setting-label",
  for: "stmp-playmode"
}, Yf = ["value"], Xf = ["value"], Zf = { class: "stmp-tab-panel" }, Qf = {
  key: 0,
  class: "stmp-provider-fields"
}, ed = ["onUpdate:modelValue", "placeholder"], td = ["onUpdate:modelValue", "placeholder"], sd = { class: "stmp-tab-panel" }, nd = { class: "stmp-setting-group" }, id = { class: "stmp-setting-label" }, rd = { class: "stmp-rules" }, od = ["onClick"], ld = { class: "stmp-rule-add" }, ad = ["placeholder"], cd = { class: "stmp-tab-panel" }, ud = { class: "stmp-data-btns" }, fd = /* @__PURE__ */ It({
  __name: "SettingsView",
  setup(e) {
    ...
    function c(D) {
      const k = t.settings.providers.find((y) => y.id === D);
      k && (k.enabled = !k.enabled, t.save());
    }
    const h = /* @__PURE__ */ he("");
    function m() {
    ...
    const C = () => {
      const D = JSON.stringify(t.settings, null, 2), k = new Blob([D], { type: "application/json" }), y = URL.createObjectURL(k), H = document.createElement("a");
      H.href = y, H.download = "st-music-player-settings.json", H.click(), URL.revokeObjectURL(y);
    }, I = () => {
      const D = document.createElement("input");
      D.type = "file", D.accept = ".json", D.onchange = async (k) => {
    ...
    return (D, k) => (A(), O("div", Pf, [
      p("div", Lf, [
        (A(), O(ie, null, je(n, (y) => p("div", {
          key: y.id,
      ...
      p("div", Of, [
        _t(p("div", Df, [
          p("div", Nf, [
            p("label", Ff, te(w(V)("Widget Mode")), 1),
            p("div", Uf, [
              (A(), O(ie, null, je(r, (y) => p("div", {
                key: y.value,
          ...
          w(t).settings.widgetMode === "dock" ? (A(), O("div", Vf, [
            p("label", jf, te(w(V)("Dock Alignment")), 1),
            p("div", Bf, [
              (A(), O(ie, null, je(o, (y) => p("div", {
                key: y.value,
          ...
          p("div", Kf, [
            p("label", zf, te(w(V)("Default Volume")) + ": " + te(w(t).settings.volume), 1),
            p("input", {
              type: "range",
              min: "0",
              max: "100",
          ...
          p("div", Jf, [
            p("label", Gf, te(w(V)("Default Play Mode")), 1),
            p("select", {
              id: "stmp-playmode",
              class: "text_pole",
        ...
        _t(p("div", Zf, [
          (A(!0), O(ie, null, je(w(t).settings.providers, (y) => (A(), O("div", {
            key: y.id,
        ...
        _t(p("div", sd, [
          p("div", nd, [
            p("label", id, te(w(V)("Custom Cue Rules (Regex)")), 1),
            p("div", rd, [
              (A(!0), O(ie, null, je(w(t).settings.customCueRules, (y, H) => (A(), O("div", {
                key: H,
                class: "stmp-rule"
              }, [
                p("code", null, te(y), 1),
            ...
            p("div", ld, [
              _t(p("input", {
                "onUpdate:modelValue": k[3] || (k[3] = (y) => h.value = y),
                class: "text_pole",
        ...
        _t(p("div", cd, [
          p("div", ud, [
            p("div", {
              ...
              k[6] || (k[6] = p("i", { class: "fa-solid fa-file-export" }, null, -1)),
            ...
            p("div", {
              ...
              k[7] || (k[7] = p("i", { class: "fa-solid fa-file-import" }, null, -1)),
...
}), dd = /* @__PURE__ */ Tt(fd, [["__scopeId", "data-v-0a41a45c"]]);
class hd {
  constructor() {
...
function yd() {
  ...
  if (!e || !e.length || (e.append(vd), ys = e.children(".inline-drawer").last()[0] ?? null, !ys)) return;
  const t = ys.querySelector("#stmp-settings-mount");
  t && en && (Jt = Ro(dd), Jt.use(en), Jt.mount(t));
}
function _d() {
  Jt && (Jt.unmount(), Jt = null), ys?.remove(), ys = null;
}
function bd(e, t, s) {
  ut = pd(), ut.on("chat-changed", () => {
...
async function Cd() {
  try {
    ...
    const t = xc();
    en = t, qt = Ro(Tf), qt.use(t), qt.mount(e);
    const s = ke(), n = Rc();
    s.init(n);
    const i = Nt();
    i.init(), i.setVolume(s.settings.volume);
    const r = new md((a) => SillyTavern.getContext().chat[a]?.mes), o = Yt();
    o.init(r), yd();
