...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), sn = (e) => e.startsWith("onUpdate:"), Se = Object.assign, Qn = (e, t) => {
  const s = e.indexOf(t);
  s > -1 && e.splice(s, 1);
}, Hr = Object.prototype.hasOwnProperty, le = (e, t) => Hr.call(e, t), q = Array.isArray, zt = (e) => Es(e) === "[object Map]", vo = (e) => Es(e) === "[object Set]", _i = (e) => Es(e) === "[object Date]", Q = (e) => typeof e == "function", ge = (e) => typeof e == "string", Ke = (e) => typeof e == "symbol", ae = (e) => e !== null && typeof e == "object", yo = (e) => (ae(e) || Q(e)) && Q(e.then) && Q(e.catch), _o = Object.prototype.toString, Es = (e) => _o.call(e), Vr = (e) => Es(e).slice(8, -1), bo = (e) => Es(e) === "[object Object]", nn = (e) => ge(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, as = /* @__PURE__ */ Zn(
...
function Gr(e) {
  const t = {};
  return e.replace(Jr, "").split(Kr).forEach((s) => {
    if (s) {
      const n = s.split(zr);
...
const qr = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", Yr = /* @__PURE__ */ Zn(qr);
function So(e) {
  return !!e || e === "";
}
function Xr(e, t) {
...
const Co = (e) => !!(e && e.__v_isRef === !0), K = (e) => ge(e) ? e : e == null ? "" : q(e) || ae(e) && (e.toString === _o || !Q(e.toString)) ? Co(e) ? K(e.value) : JSON.stringify(e, Io, 2) : String(e), Io = (e, t) => Co(t) ? Io(e, t.value) : zt(t) ? {
...
function Lo(e) {
  ...
  for (; n; ) {
    const i = n.prevDep;
    n.version === -1 ? (n === s && (s = i), ii(n), Qr(n)) : t = n, n.dep.activeLink = n.prevActiveLink, n.prevActiveLink = void 0, n = i;
  }
...
class oi {
  ...
  track(t) {
    ...
    if (s === void 0 || s.sub !== de)
      s = this.activeLink = new el(de, this), de.deps ? (s.prevDep = de.depsTail, de.depsTail.nextDep = s, de.depsTail = s) : de.deps = de.depsTail = s, Do(s);
...
const il = /* @__PURE__ */ Zn("__proto__,__v_isRef,__isVue"), No = new Set(
...
class Fo {
  ...
  get(t, s, n) {
    ...
    if (s === "__v_isShallow")
      return o;
    if (s === "__v_raw")
      return n === (i ? o ? gl : jo : o ? Vo : Ho).get(t) || // receiver is not the reactive proxy, but has the same prototype
    ...
    if ((Ke(s) ? No.has(s) : il(s)) || (i || Ee(t, "get", s), o))
      return l;
    if (/* @__PURE__ */ _e(l)) {
...
const ll = /* @__PURE__ */ new Uo(), al = /* @__PURE__ */ new rl(), cl = /* @__PURE__ */ new Uo(!0);
...
const Ho = /* @__PURE__ */ new WeakMap(), Vo = /* @__PURE__ */ new WeakMap(), jo = /* @__PURE__ */ new WeakMap(), gl = /* @__PURE__ */ new WeakMap();
function ml(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function yl(e, t) {
  return /* @__PURE__ */ _e(e) ? e : new _l(e, t);
}
class _l {
  constructor(t, s) {
...
function Bo(e) {
  return /* @__PURE__ */ pt(e) ? e : new Proxy(e, bl);
}
// @__NO_SIDE_EFFECTS__
function xl(e) {
...
function Il(e, t, s = !1) {
  let n, i;
  return Q(e) ? n = e : (n = e.get, i = e.set), new Cl(n, i, s);
}
...
function El(e, t, s = fe) {
  const { immediate: n, deep: i, once: o, scheduler: r, augmentJob: l, call: a } = s, f = (k) => i ? k : /* @__PURE__ */ He(k) || i === !1 || i === 0 ? ht(k, 1) : ht(k);
  let c, p, m, v, I = !1, T = !1;
  if (/* @__PURE__ */ _e(e) ? (p = () => e.value, I = /* @__PURE__ */ He(e)) : /* @__PURE__ */ pt(e) ? (p = () => f(e), I = !0) : q(e) ? (T = !0, I = e.some((k) => /* @__PURE__ */ pt(k) || /* @__PURE__ */ He(k)), p = () => e.map((k) => {
    if (/* @__PURE__ */ _e(k))
      return k.value;
    if (/* @__PURE__ */ pt(k))
      return f(k);
  ...
  let x = T ? new Array(e.length).fill(Ls) : Ls;
  const C = (k) => {
    if (!(!(c.flags & 1) || !c.dirty && !k))
      if (t) {
        const B = c.run();
        if (k || i || I || (T ? B.some((ne, R) => nt(ne, x[R])) : nt(B, x))) {
          m && m();
          const ne = Pt;
          Pt = c;
          try {
  ...
  }, t ? n ? C(!0) : x = c.run() : r ? r(C.bind(null, !0), !0) : c.run(), U.pause = c.pause.bind(c), U.resume = c.resume.bind(c), U.stop = U, U;
}
...
function ci(e) {
  if (!(e.flags & 1)) {
    ...
    !(e.flags & 2) && t >= ws(s) ? Re.push(e) : Re.splice(kl(t), 0, e), e.flags |= 1, Ko();
  }
}
function Ko() {
  Ks || (Ks = Wo.then(Jo));
...
const Ll = /* @__PURE__ */ Symbol.for("v-scx"), $l = () => fs(Ll);
function Fe(e, t, s) {
  return Yo(e, t, s);
}
function Yo(e, t, s = fe) {
  ...
  const c = Le;
  l.call = (v, I, T) => ze(v, c, I, T);
  let p = !1;
  o === "post" ? l.scheduler = (v) => {
    ke(v, c && c.suspense);
  } : o !== "sync" && (p = !0, l.scheduler = (v, I) => {
    I ? v() : ci(v);
  }), l.augmentJob = (v) => {
...
const bt = /* @__PURE__ */ new WeakMap(), Zo = /* @__PURE__ */ Symbol("_vte"), Qo = (e) => e.__isTeleport, Lt = (e) => e && (e.disabled || e.disabled === ""), Dl = (e) => e && (e.defer || e.defer === ""), Ci = (e) => typeof SVGElement < "u" && e instanceof SVGElement, Ii = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, Vn = (e, t) => {
  const s = e && e.to;
  ...
  process(e, t, s, n, i, o, r, l, a, f) {
    const {
      ...
      pc: p,
      pbc: m,
      o: { insert: v, querySelector: I, createText: T, createComment: z, parentNode: U }
    } = f, x = Lt(t.props);
    ...
    const k = (R, N, _) => {
      ...
      const N = Lt(R.props), _ = R.target = Vn(R.props, I), j = jn(_, R, T, v);
      _ && (r !== "svg" && Ci(_) ? r = "svg" : r !== "mathml" && Ii(_) && (r = "mathml"), i && i.isCE && (i.ce._teleportTargets || (i.ce._teleportTargets = /* @__PURE__ */ new Set())).add(_), N || (k(R, _, j), os(R, !1)));
    }, ne = (R) => {
      const N = () => {
        if (bt.get(R) === N) {
          if (bt.delete(R), Lt(R.props)) {
            const _ = U(R.el) || s;
            k(R, _, R.anchor), os(R, !0);
          }
          B(R);
        }
      };
    ...
    if (e == null) {
      const R = t.el = T(""), N = t.anchor = T("");
      if (v(R, s, n), v(N, s, n), Dl(t.props) || o && o.pendingBranch) {
        ne(t);
        return;
      }
      x && (k(t, s, N), os(t, !0)), B();
      ...
      const _ = t.target = e.target, j = t.targetAnchor = e.targetAnchor, Y = Lt(e.props), E = Y ? s : _, W = Y ? R : j;
      if (r === "svg" || Ci(_) ? r = "svg" : (r === "mathml" || Ii(_)) && (r = "mathml"), C ? (m(
        e.dynamicChildren,
        C,
        E,
        i,
  ...
  remove(e, t, s, { um: n, o: { remove: i } }, o) {
    const {
      ...
      target: p,
      props: m
    } = e, v = Lt(m), I = o || !v, T = bt.get(e);
    if (T && (T.flags |= 8, bt.delete(e)), p && (i(f), i(c)), o && i(a), !T && (v || p) && r & 16)
...
function Fl(e, t, s, n, i, o, {
    ...
    for (; x; ) {
      if (x && x.nodeType === 8) {
        if (x.data === "teleport start anchor")
          ...
          t.targetAnchor = x, z._lpa = t.targetAnchor && r(t.targetAnchor);
          break;
        }
      }
      x = r(x);
  ...
  if (I) {
    const z = I._lpa || I.firstChild;
    t.shapeFlag & 16 && (T ? (v(e, t), m(I, z), t.targetAnchor || jn(
      I,
      t,
      c,
      f,
      ...
      l(e) === I ? e : null
    )) : (t.anchor = r(e), m(I, z), t.targetAnchor || jn(I, t, c, f), p(
      z && r(z),
      t,
      I,
      s,
  ...
  } else T && t.shapeFlag & 16 && (v(e, t), t.targetStart = e, t.targetAnchor = r(e));
  ...
  setup(e, { slots: t }) {
    ...
    return () => {
      ...
      if (c && c.type !== Pe && !$t(c, a) && tr(s).type !== Pe) {
        ...
        l === "in-out" && a.type !== Pe ? p.delayLeave = (m, v, I) => {
          const T = nr(
            n,
            c
          );
          T[String(c.key)] = c, m[je] = () => {
...
function Bn(e, t, s, n, i) {
  const {
    ...
    onAfterAppear: x,
    onAppearCancelled: C
  } = t, k = String(e.key), B = nr(s, e), ne = (_, j) => {
    _ && ze(
      _,
      n,
      9,
    ...
    const Y = j[1];
    ne(_, j), q(_) ? _.every((E) => E.length <= 1) && Y() : _.length <= 1 && Y();
  }, N = {
    mode: r,
    persisted: l,
    beforeEnter(_) {
      ...
      const Y = B[k];
      Y && $t(e, Y) && Y.el[je] && Y.el[je](), ne(j, [_]);
    },
    enter(_) {
      if (B[k] === e) return;
      let j = f, Y = c, E = p;
      ...
      let W = !1;
      _[ss] = (me) => {
        W || (W = !0, me ? ne(E, [_]) : ne(Y, [_]), N.delayedLeave && N.delayedLeave(), _[ss] = void 0);
      };
      const ee = _[ss].bind(null, !1);
      j ? R(j, [_, ee]) : ee();
    },
    leave(_, j) {
      ...
      let E = !1;
      _[je] = (ee) => {
        E || (E = !0, j(), ee ? ne(T, [_]) : ne(I, [_]), _[je] = void 0, B[Y] === e && delete B[Y]);
      };
      const W = _[je].bind(null, !1);
      B[Y] = e, v ? R(v, [_, W]) : W();
    },
    clone(_) {
      const j = Bn(
...
function ds(e, t, s, n, i = !1) {
  ...
  const o = n.shapeFlag & 4 ? mn(n.component) : n.el, r = i ? null : o, { i: l, r: a } = e, f = t && t.r, c = l.refs === fe ? l.refs = {} : l.refs, p = l.setupState, m = /* @__PURE__ */ oe(p), v = p === fe ? mo : (T) => Ei(c, T) ? !1 : le(m, T), I = (T, z) => !(z && Ei(c, z));
  if (f != null && f !== a) {
    if (Ai(t), ge(f))
  ...
  if (Q(a)) {
    ...
    const T = ge(a), z = /* @__PURE__ */ _e(a);
    if (T || z) {
      const U = () => {
        if (e.f) {
          const x = T ? v(a) ? p[a] : c[a] : I() || !e.k ? a.value : c[e.k];
          if (i)
            q(x) && Qn(x, o);
          else if (q(x))
            ...
            const C = [o];
            I(a, e.k) && (a.value = C), e.k && (c[e.k] = C);
          }
        } else T ? (c[a] = r, v(a) && (p[a] = r)) : z && (I(a, e.k) && (a.value = r), e.k && (c[e.k] = r));
      };
      if (r) {
        const x = () => {
          U(), Js.delete(e);
        };
        x.id = -1, Js.set(e, x), ke(x, s);
      } else
        Ai(e), U();
    }
  }
...
function rr(e, t, s = Le) {
  ...
  if (dn(t, n, s), s) {
    let i = s.parent;
    for (; i && i.parent; )
      fn(i.parent.vnode) && Kl(n, t, s, i), i = i.parent;
  }
}
function Kl(e, t, s, n) {
  const i = dn(
...
const Wn = (e) => e ? Er(e) ? mn(e) : Wn(e.parent) : null, ps = (
...
), An = (e, t) => e !== fe && !e.__isScriptSetup && le(e, t), ea = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
...
function ta(e) {
  ...
  if (re(zl, p), re(hn, m), re(Jl, v), re(Gl, I), re(Bl, T), re(Wl, z), re(Zl, N), re(Xl, ne), re(Yl, R), re(ui, x), re(lr, k), re(ql, _), q(j))
    if (j.length) {
  ...
  B && e.render === it && (e.render = B), Y != null && (e.inheritAttrs = Y), E && (e.components = E), W && (e.directives = W), _ && or(e);
}
function sa(e, t, s = it) {
  q(e) && (e = zn(e));
  for (const n in e) {
    const i = e[n];
    let o;
...
let Dt = null;
const aa = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${Je(t)}Modifiers`] || e[`${It(t)}Modifiers`];
function ca(e, t, ...s) {
  if (e.isUnmounted) return;
  const n = e.vnode.props || fe;
  let i = s;
  const o = t.startsWith("update:"), r = o && aa(n, t.slice(7));
  r && (r.trim && (i = s.map((c) => ge(c) ? c.trim() : c)), r.number && (i = s.map(ei)));
  let l, a = n[l = wn(t)] || // also try camelCase event handler (#2249)
  n[l = wn(Je(t))];
  !a && o && (a = n[l = wn(It(t))]), a && ze(
    a,
    e,
    6,
    i
...
function fr(e, t, s = !1) {
  const n = s ? ua : t.emitsCache, i = n.get(e);
  if (i !== void 0)
    return i;
  const o = e.emits;
  let r = {}, l = !1;
...
function Li(e) {
  ...
  let C = U;
  if (x && T !== !1) {
    const k = Object.keys(x), { shapeFlag: B } = C;
    k.length && B & 7 && (o && k.some(sn) && (x = da(
      x,
      o
    )), C = Ct(C, x, !1, !0));
  }
...
function pa({ vnode: e, parent: t, suspense: s }, n) {
  for (; t; ) {
    const i = t.subTree;
...
function ga(e, t, s, n = !1) {
  ...
  for (const r in e.propsOptions[0])
    r in i || (i[r] = void 0);
  s ? e.props = n ? i : /* @__PURE__ */ vl(i) : e.type.props ? e.props = i : e.props = o, e.attrs = o;
}
function ma(e, t, s, n) {
  const {
    props: i,
  ...
  if (
    ...
    for (const p in l)
      ...
      ((c = It(p)) === p || !le(t, c))) && (a ? s && // for camelCase
...
function vr(e, t, s = !1) {
  const n = s ? va : t.propsCache, i = n.get(e);
  if (i)
    return i;
  const o = e.props, r = {}, l = [];
  let a = !1;
  ...
  if (q(o))
    ...
    for (const c in o) {
      const p = Je(c);
      if (Oi(p)) {
        const m = o[c], v = r[p] = q(m) || Q(m) ? { type: m } : Se({}, m), I = v.type;
        let T = !1, z = !0;
        if (q(I))
          for (let U = 0; U < I.length; ++U) {
            const x = I[U], C = Q(x) && x.name;
            if (C === "Boolean") {
              T = !0;
              break;
            } else C === "String" && (z = !1);
...
const fi = (e) => e === "_" || e === "_ctx" || e === "$stable", di = (e) => q(e) ? e.map(st) : [st(e)], ya = (e, t, s) => {
  if (t._n)
    return t;
...
function wa(e, t) {
  ...
  const {
  ...
  } = e, T = (u, h, g, A = null, S = null, b = null, F = void 0, D = null, P = !!h.dynamicChildren) => {
    if (u === h)
      return;
    u && !$t(u, h) && (A = Ms(u), Oe(u, S, b, !0), u = null), h.patchFlag === -2 && (P = !1, h.dynamicChildren = null);
    ...
    X != null && S ? ds(X, u && u.ref, b, h || u, !h) : X == null && u && u.ref != null && ds(u.ref, null, b, u, !0);
  }, z = (u, h, g, A) => {
    if (u == null)
      n(
        h.el = l(h.children),
    ...
    if (P = u.el = r(
      ...
      for (const ue in X)
        ue !== "value" && !as(ue) && o(P, ue, null, X[ue], b, A);
      "value" in X && o(P, "value", null, X.value, b), (w = X.onVnodeBeforeMount) && Qe(w, A, u);
    }
    ...
    if (S) {
      let b = S.subTree;
      if (h === b || Sr(b.type) && (b.ssContent === h || b.ssFallback === h)) {
        const F = S.vnode;
        R(
          u,
          F,
    ...
    w && (!u.dynamicChildren || u.dynamicChildren.length !== w.length) && (P = 0, F = !1, w = null), (V.innerHTML && J.innerHTML == null || V.textContent && J.textContent == null) && c(D, ""), w ? j(
      ...
      if (P & 16)
        ...
        for (let ue = 0; ue < ie.length; ue++) {
          ...
          (Ie !== xe || ce === "value") && o(D, ce, xe, Ie, S, g);
        }
      }
    ...
    const D = () => {
      if (u.isMounted) {
        ...
        u.subTree = Ie, T(
          ...
          S,
          b
        ), V.el = Ie.el, ce === null && pa(u, Ie.el), Z && ke(Z, S), (xe = V.props && V.props.onVnodeUpdated) && ke(
          () => Qe(xe, ie, V, ue),
          S
        );
      } else {
        let V;
        const { el: J, props: Z } = h, { bm: ie, m: ue, parent: ce, root: xe, type: Ie } = u, Ye = hs(h);
    ...
    u.vnode = h, u.next = null, ma(u, h.props, A, g), ba(u, h.children, g), ot(), Si(u), rt();
  }, G = (u, h, g, A, S, b, F, D, P = !1) => {
    ...
    Z & 8 ? (X & 16 && Zt(w, S, b), V !== w && c(g, V)) : X & 16 ? Z & 16 ? Ce(
      w,
      V,
      g,
      A,
    ...
    if (w > V) {
      ...
      for (w = Z; w <= V; w++) {
        ...
        Ze === void 0 ? Oe(De, S, b, !0) : (es[Ze - ie] = w + 1, Ze >= Xe ? Xe = Ze : Ye = !0, T(
          De,
          h[Ze],
          g,
          null,
    ...
    const { el: b, type: F, transition: D, children: P, shapeFlag: w } = u;
    if (w & 6) {
    ...
    if (A !== 2 && w & 1 && D)
      if (A === 0)
        D.persisted && !b[je] ? n(b, h, g) : (D.beforeEnter(b), n(b, h, g), ke(() => D.enter(b), S));
      else {
        const { leave: V, delayLeave: J, afterLeave: Z } = D, ie = () => {
          u.ctx.isUnmounted ? i(b) : n(b, h, g);
        }, ue = () => {
          const ce = b._isLeaving || !!b[je];
          b._isLeaving && b[je](
            !0
            /* cancelled */
          ), D.persisted && !ce ? ie() : V(b, () => {
            ie(), Z && Z();
          });
        };
        J ? J(b, ie, ue) : ue();
    ...
    if (ce && (xe = F && F.onVnodeBeforeUnmount) && Qe(xe, h, u), X & 6)
      ...
      (b !== se || V > 0 && V & 64) ? Zt(
        ...
        !1,
        !0
      ) : (b === se && V & 384 || !S && X & 16) && Zt(P, h, g), A && Ft(u);
    }
    const Ie = ie != null && Z == null;
    (ce && (xe = F && F.onVnodeUnmounted) || ue || Ie) && ke(() => {
      xe && Qe(xe, h, u), ue && At(u, null, h, "unmounted"), Ie && (u.el = null);
    }, g);
  }, Ft = (u) => {
    ...
    if (u.shapeFlag & 1 && S && !S.persisted) {
      const { leave: F, delayLeave: D } = S, P = () => F(g, b);
      D ? D(u.el, b, P) : P();
    } else
      b();
  }, _n = (u, h) => {
    ...
    const { bum: A, scope: S, job: b, subTree: F, um: D, m: P, a: w } = u;
    Di(P), Di(w), A && Us(A), S.stop(), b && (b.flags |= 8, Oe(F, u, h, g)), D && ke(D, h), ke(() => {
      u.isUnmounted = !0;
    }, h);
  }, Zt = (u, h, g, A = !1, S = !1, b = 0) => {
  ...
  const gi = (u, h, g) => {
    let A;
    u == null ? h._vnode && (Oe(h._vnode, null, null, !0), A = h._vnode.component) : T(
      h._vnode || null,
      u,
      h,
      null,
...
const te = Ea;
function Ea(e, t = null, s = null, n = 0, i = null, o = !1) {
  if ((!e || e === Ql) && (e = Pe), Ys(e)) {
    const l = Ct(
      e,
      t,
...
function Xs(e, t) {
  ...
  if (t == null)
    ...
    t = String(t), n & 64 ? (s = 16, t = [Tr(t)]) : s = 8;
...
function Pa(e, t, s) {
  ...
  return o.ctx = { _: o }, o.root = t ? t.root : o, o.emit = ca.bind(null, o), e.ce && e.ce(o), o;
}
let Le = null;
const pi = () => Le || We;
let Zs, Gn;
...
function La(e, t = !1, s = !1) {
  t && Gn(t);
  const { props: n, children: i } = e.vnode, o = Er(e);
  ga(e, n, o, t), _a(e, i, s || t);
...
function Fi(e, t, s) {
  Q(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : ae(t) && (e.setupState = Bo(t)), Ar(e);
}
function Ar(e, t, s) {
  const n = e.type;
...
const $e = (e, t) => /* @__PURE__ */ Il(e, t, Is);
function Fa(e, t, s) {
  try {
    qs(-1);
...
const kr = qn ? (e) => qn.createHTML(e) : (e) => e, Ha = "http://www.w3.org/2000/svg", Va = "http://www.w3.org/1998/Math/MathML", ct = typeof document < "u" ? document : null, Hi = ct && /* @__PURE__ */ ct.createElement("template"), ja = {
  insert: (e, t, s) => {
...
}, yt = "transition", ns = "animation", Ts = /* @__PURE__ */ Symbol("_vtc"), Mr = {
  name: String,
  type: String,
  css: {
    type: Boolean,
...
function za(e) {
  ...
  const {
    ...
    const me = E ? R : x, re = () => _(W, E, ee);
    Mt(me, [W, re]), ji(() => {
      Rt(W, E ? a : o), at(W, E ? c : l), Vi(me) || Bi(W, n, T, re);
    });
  };
  return Se(t, {
    onBeforeEnter(E) {
    ...
    onEnterCancelled(E) {
      _(E, !1, void 0, !0), Mt(C, [E]);
    },
    onAppearCancelled(E) {
      _(E, !0, void 0, !0), Mt(N, [E]);
    },
    onLeaveCancelled(E) {
      j(E), Mt(B, [E]);
    }
...
function qa(e, t) {
  const s = window.getComputedStyle(e), n = (I) => (s[I] || "").split(", "), i = n(`${yt}Delay`), o = n(`${yt}Duration`), r = Wi(i, o), l = n(`${ns}Delay`), a = n(`${ns}Duration`), f = Wi(l, a);
  let c = null, p = 0, m = 0;
...
const Qs = /* @__PURE__ */ Symbol("_vod"), Rr = /* @__PURE__ */ Symbol("_vsh"), Ds = {
...
function is(e, t) {
  e.style.display = t ? e[Qs] : "none", e[Rr] = !t;
}
...
function Qa(e, t, s) {
  ...
  Qs in e && (e[Qs] = o ? n.display : "", e[Rr] && (n.display = "none"));
}
...
function xc() {
  ...
  const i = ai({
    install(o) {
      vn(i), i._a = o, o.provide(Or, i), o.config.globalProperties.$pinia = i, n.forEach((r) => s.push(r)), n = [];
    },
    use(o) {
...
function Tc(e, t, s, n) {
  ...
  function f() {
    ...
    const c = /* @__PURE__ */ xl(s.state.value[e]);
  ...
  return a = Nr(e, f, t, s, n, !0), a;
}
function Nr(e, t, s = {}, n, i, o) {
  let r;
  ...
  const C = (N, _ = "") => {
    ...
    $reset: U,
    $subscribe(N, _ = {}) {
      const j = io(p, N, _.detached, () => Y()), Y = r.run(() => Fe(() => n.state.value[e], (E) => {
        (_.flush === "sync" ? c : f) && N({
          storeId: e,
          type: ms.direct,
          events: v
  ...
  for (const N in R) {
    const _ = R[N];
    if (/* @__PURE__ */ _e(_) && !Ic(_) || /* @__PURE__ */ pt(_))
      o || (I && Cc(_) && (/* @__PURE__ */ _e(_) ? _.value = I[N] : Xn(_, I[N])), n.state.value[e][N] = _);
  ...
  }), I && o && s.hydrate && s.hydrate(B.$state, I), f = !0, c = !0, B;
}
/*! #__NO_SIDE_EFFECTS__ */
// @__NO_SIDE_EFFECTS__
function yn(e, t, s) {
  ...
  function r(l, a) {
    ...
    l || (f ? fs(Or, null) : null), l && vn(l), l = $r, l._s.has(n) || (o ? Nr(n, t, i, l) : Tc(n, i, l)), l._s.get(n);
  }
  return r.$id = n, r;
}
function Ec() {
...
const Xt = /* @__PURE__ */ yn("playlist", {
  ...
  actions: {
    ...
    async resolveAndPlay(e) {
      ...
      if (!n) return;
      let i = null;
      const o = Fr(s.settings.providers);
  ...
  setup(e) {
    ...
    Fe(() => t.currentLyricIndex, I), Fe(() => t.lyrics, () => {
      p.value = [], I();
    });
    const T = /* @__PURE__ */ he(null), z = /* @__PURE__ */ he(null), U = /* @__PURE__ */ he(0), x = /* @__PURE__ */ he(0);
    function C() {
      const R = T.value, N = z.value;
      if (!R || !N) {
        U.value = 0;
        return;
      }
      const _ = R.scrollWidth - N.clientWidth;
      _ > 3 && f.value > 0 ? (x.value = Math.max(200, f.value - 200), requestAnimationFrame(() => {
        requestAnimationFrame(() => {
          U.value = -_;
        });
      })) : U.value = 0;
    ...
    Fe(a, () => {
      x.value = 0, U.value = 0, Ne(() => requestAnimationFrame(C));
    });
    function k() {
      i.value = !0;
    }
    ...
    return hn(() => {
      ...
      d("div", {
        ...
        y(t).lyrics.length > 0 ? (M(), O("div", {
          ...
          (M(!0), O(se, null, Be(y(t).lyrics, (_, j) => (M(), O("span", {
            key: j,
            ref_for: !0,
            ref: (Y) => v(Y, j),
    ...
    return (p, m) => (M(), O("div", mu, [
      ...
      y(t).isEmpty ? (M(), O("div", _u, K(y(L)("No Songs")), 1)) : (M(), O(se, { key: 2 }, Be(["chat", "user", "local"], (v) => d("div", {
        ...
        l.value[v].length ? (M(), O(se, { key: 0 }, [
          d("div", bu, K(a[v]), 1),
          (M(!0), O(se, null, Be(l.value[v], (I) => (M(), O("div", {
            key: I.item.id,
            class: pe(["stmp-item", { active: I.index === y(t).currentIndex }]),
            onClick: (T) => f(I.index)
          }, [
            d("span", wu, K(I.index + 1), 1),
            d("div", Su, [
              d("span", Cu, K(I.item.song), 1),
              I.item.artist ? (M(), O("span", Iu, K(I.item.artist), 1)) : Te("", !0)
            ]),
            d("button", {
              class: "stmp-item-del",
              onClick: Wt((T) => c(I.index), ["stop"])
            }, [
              te(ve, {
                name: "x",
                size: 14
  ...
  setup(e) {
    ...
    async function l() {
      ...
      const v = Fr(n.settings.providers);
      await t.search(v);
    }
    const a = () => {
      l();
    ...
    function f(v) {
      ...
      z >= T && s.play(z), setTimeout(() => {
        o.value.add(I), r.value = null;
      }, 600);
    }
    function c(v) {
      const I = v.provider + v.id;
      o.value.has(I) || (s.addFromSearch(v), o.value.add(I));
    }
    function p(v) {
    ...
    return (v, I) => (M(), O("div", ku, [
      ...
      y(t).isSearching ? (M(), O("div", Ou, K(y(L)("Searching...")), 1)) : i.value && !y(t).results.length ? (M(), O("div", Du, K(y(L)("No results")), 1)) : !i.value && !y(t).results.length ? (M(), O("div", Nu, K(y(L)("Type a song name to search")), 1)) : Te("", !0),
      y(t).results.length ? (M(), O("div", Fu, [
        (M(!0), O(se, null, Be(y(t).results, (T) => (M(), O("div", {
          key: T.provider + T.id,
          class: pe(["stmp-result", { "stmp-result-playing": m(T) }])
        }, [
          d("div", {
            class: "stmp-result-info",
            onClick: (z) => f(T)
          }, [
            d("span", Hu, K(T.name), 1),
            T.artist ? (M(), O("span", Vu, K(T.artist), 1)) : Te("", !0)
          ], 8, Uu),
          d("button", {
            class: pe(["stmp-icon-btn stmp-result-add", { added: p(T) }]),
            "aria-label": p(T) ? y(L)("Added") : y(L)("Add to list"),
            onClick: Wt((z) => c(T), ["stop"])
          }, [
            te(ve, {
              name: p(T) ? "check" : "plus",
              size: 16
  ...
  key: 0,
  class: "stmp-overlay"
}, yf = { class: "stmp-overlay-header" }, _f = { class: "stmp-overlay-title" }, bf = ["aria-label"], xf = { class: "stmp-overlay-body" }, wf = /* @__PURE__ */ Tt({
  __name: "PlayerPanel",
  emits: ["collapse"],
  setup(e) {
    ...
    ), m = /* @__PURE__ */ he(0), v = /* @__PURE__ */ he([]), I = /* @__PURE__ */ he(null);
    function T(E, W) {
      E && (v.value[W] = E);
    }
    async function z() {
      await Ne();
      const E = t.currentLyricIndex, W = I.value;
      if (!W || E < 0) {
        m.value = 0;
        return;
      }
  ...
  setup(e) {
    ...
    let v = 0, I = 0, T = 0, z = 0, U = !1, x = !1, C = 0, k = !1, B = null, ne = null;
    function R(H) {
      if (r.value) return;
      const G = H.target;
      ...
      be && (v = H.clientX, I = H.clientY, T = be.left, z = be.top, U = !1, x = !0, C = Date.now(), k = !1, i.value && (i.value.style.left = be.left + "px", i.value.style.top = be.top + "px", i.value.style.right = "auto", i.value.style.bottom = "auto"), B = N, ne = _, document.addEventListener("pointermove", B), document.addEventListener("pointerup", ne), H.preventDefault());
    }
    function N(H) {
      if (!i.value || !x) return;
      const G = H.clientX - v, be = H.clientY - I;
    ...
    function _() {
      x = !1, B && document.removeEventListener("pointermove", B), ne && document.removeEventListener("pointerup", ne), B = null, ne = null;
      const H = Date.now() - C;
      if (U) {
        if (k = !0, i.value) {
    ...
    return ui(() => {
      _(), o && (o.disconnect(), o = null), window.removeEventListener("resize", re), window.removeEventListener("keydown", m);
  ...
  setup(e, { emit: t }) {
    ...
    return (i, o) => (M(), O("label", {
      ...
      e.label ? (M(), O("span", Ef, K(e.label), 1)) : Te("", !0),
      d("span", Af, [
        d("input", {
          type: "checkbox",
  ...
  setup(e) {
    ...
    function p(U) {
      const x = t.settings.providers.find((C) => C.id === U);
      ...
      d("div", $f, [
        ...
        _t(d("div", Nd, [
          ...
          d("div", zd, [
            ...
            x[10] || (x[10] = d("div", { class: "stmp-about-name" }, "晓乐", -1)),
            ...
            x[11] || (x[11] = d("div", { class: "stmp-about-copyright" }, [
              d("a", {
...
}), Zd = /* @__PURE__ */ Et(Xd, [["__scopeId", "data-v-139ecd87"]]);
class Qd {
  constructor() {
...
function ih() {
  ...
  t && en && (qt = Lr(Zd), qt.use(en), qt.mount(t));
}
function oh() {
...
async function uh() {
  try {
    ...
    ys = () => {
      rh(o, r, s), lh(o, r, s);
    }, l.eventSource.on(l.event_types.APP_READY, ys), console.log("[晓乐] 播放器加载完成");
  } catch (e) {
...
async function ah() {
  ...
  try {
    ...
    console.error("[晓乐] clean: failed to clear localforage:", e);
  }
}
async function dh() {
  await ah(), Ur();
