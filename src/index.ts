...
export async function init(): Promise<void> {
  try {
    ...
    console.log('[小月] 播放器加载完成');
  } catch (err) {
    console.error('[小月] init failed:', err);
  }
}
...
export async function clean(): Promise<void> {
  try {
    ...
    console.error('[小月] clean: failed to delete settings:', err);
  }
  ...
  try {
    ...
    console.error('[小月] clean: failed to clear localforage:', err);
  }
}
